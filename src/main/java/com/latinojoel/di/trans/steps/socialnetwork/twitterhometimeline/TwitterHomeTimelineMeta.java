...
import com.latinojoel.di.ui.trans.steps.socialnetwork.TwitterHomeTimelineDialog;
 ...
 * @since 1.0.0
 */
@Step(id = "TwitterHomeTimeline", name = "TwitterHomeTimeline.Step.Name",
    description = "TwitterHomeTimeline.Step.Description",
    categoryDescription = "TwitterHomeTimeline.Step.Category",
...
public class TwitterHomeTimelineMeta extends BaseStepMeta implements
    StepMetaInterface {

  /** for i18n purposes. **/
  private static final Class<?> PKG = TwitterHomeTimelineMeta.class;
  ...
  public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta,
    ...
    return new TwitterHomeTimelineDialog(shell, (BaseStepMeta) meta,
        transMeta, name);
  }
  ...
  public StepInterface getStep(StepMeta stepMeta,
      ...
      Trans disp) {
    return new TwitterHomeTimeline(stepMeta, stepDataInterface, cnr,
        transMeta, disp);
  }
  ...
  public StepDataInterface getStepData() {
    return new TwitterHomeTimelineData();
  }
